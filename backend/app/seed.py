...
# ===== 演示人格：虚构用户「小林」，全部内容为虚构，不含任何真实个人信息 =====
# 注：公司名（青柠金服 / 星澜智能 / 澄屿心理）均为虚构，如有雷同纯属巧合。
...
DEMO_FACTS: list[tuple[str, str, float]] = [
    ("career", "有三段实习：青柠金服（金融科技）产品经理实习、星澜智能 AI 产品运营实习、澄屿心理 AI 心理健康产品助理", 0.9),
    ("career", "正在投递几家大厂的 AI 产品经理秋招岗位，重点关注 AI Agent 方向", 0.85),
    ("event", "之前的产品岗面试在需求拆解和数据分析环节被问住了，从此对面试有点心理阴影", 0.9),
    ("event", "最近独立做了一个个人 AI Agent 项目「5 年后的我」：分层记忆库 + 反谄媚推理", 0.85),
    ("goal", "毕业论文做的是量化研究，正在收尾阶段", 0.7),
    ("personality", "习惯用做项目和作品来证明自己，不擅长在面试中直接推销自己", 0.8),
    ("goal", "纠结过是否读博，最终确定先就业、在产业里做 AI 产品", 0.6),
]

DEMO_REFLECTIONS: list[tuple[str, str]] = [
    ("pattern", "反复在「实习经历不够硬核」和「面试基本功不足」两点上焦虑，但应对模式始终没变：用做具体项目来对冲不确定性。焦虑主题重复出现，行动路径单一。"),
